  ...
  state = {
    ...
    return(
        <div className="container">
                     {AuthIndicater}
                   <Switch>
                          <Route exact path="/succfull" component={() => <PaperCreatedSuccessfully content ="Your Paper is Created Successfully"/>} />
                          <Route exact path="/mainPage" component={MainPage}/>
                          <Route exact path="/Auth" component={() => <Auth isSignUp = { false }/>}/>
                          <Route exact path="/getAnswer" component={() => <PaperCreatedSuccessfully content = "Answer is Recorded Successfully"/>} />
                          <Route exact path="/createPapers" component= {CreateElement}/>
                          <Route exact path="/SeePapersAndResponce" component={AdminElement}/>
                          <Route exact path="/allPaperContainer" component={() => <AllQuestions idToken = {this.props.idToken} userId = {this.props.userId}/> }/>
                   </Switch>
            </div>
    )
  }
...
export default connect(mapStateToProps,mapDispathchToProps)(Frontside)
