...
class ResponceFromServer extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('/Responces/' + this.props.id + '.json').then(responce => {
    ...
    let finalData = 
                        ...
                        : null}
                        {this.state.tempUser ? <SingleResponce tempUser = {this.state.tempUser} id = { this.props.id }/> : null}
...
export default connect(mapPropsToState , mapDispathchToProps)(ResponceFromServer);